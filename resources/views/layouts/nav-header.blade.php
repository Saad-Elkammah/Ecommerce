                                        ...
                                        <div class="dropdown-menu" aria-labelledby="myaccount">
                                            @auth
                                                <a class="dropdown-item"
                                                    href="{{ route('users.profile.edit') }}">my profile</a>
                                                <form action="{{ route('users.logout') }}" method="post"  style="font-size: 12px;">
                                                    @csrf
                                                    <button type="submit" class="dropdown-item" style="cursor: pointer;">logout</button>
                                                </form>
                                            @endauth
                                            @guest
                                            <a class="dropdown-item" href="{{ route('users.login') }}">
                                                login</a>
                                            <a class="dropdown-item"
                                                href="{{ route('users.register') }}">register</a>
                                            @endguest
                                        </div>
                                    </div>
                                </li>
                            ...
                            <div class="header-mini-cart">
                                ...
                                <ul class="cart-list">
                                    <li>
                                        <div class="cart-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('assets/img/cart/cart-1.jpg') }}"
                                                    alt=""></a>
                                        </div>
                                        <div class="cart-info">
                                    ...
                                    <li>
                                        <div class="cart-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('assets/img/cart/cart-2.jpg') }}"
                                                    alt=""></a>
                                        </div>
                                        <div class="cart-info">
                ...
                <div class="col-lg-12">
                    <div class="main-header-inner">
                        <div class="category-toggle-wrap">
                            ...
                            <nav class="category-menu hm-1" style="display: none">
                                <ul>
